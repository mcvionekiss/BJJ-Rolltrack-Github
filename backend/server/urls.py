...
from server.views import LoginView, LogoutView, RegisterView, get_csrf_token, CheckinView, check_student, available_classes_today, class_details, checkin, guest_checkin
...
urlpatterns = [
    ...
    path("api/guest_checkin/", guest_checkin, name="guest_checkin"),
