...
def class_details(request, classID):
    ...
    try:
        ...
        import traceback
        print(f"Error in class_details for classID {classID}: {str(e)}")
        print(traceback.format_exc())
        return JsonResponse({"success": False, "message": "An error occurred while retrieving class details", "error": str(e)}, status=500)
