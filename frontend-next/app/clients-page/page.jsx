...
function ClientsPage() {
  ...
  const handleDelete = (clientId) => {
    ...
    if (confirmDelete) {
      const updatedClients = filteredClients.filter(
        ...
        <Paper elevation={3} sx={{ p: { xs: 2, sm: 3, md: 4 }, mt: 5 }}>
          ...
          >
            ...
            >
              ...
              <MenuItem onClick={() => handleFilterSelect("gender")}>
                Gender
              </MenuItem>
              <MenuItem onClick={() => handleFilterSelect("skillLevel")}>
                Skill Level
              </MenuItem>
            </Menu>
          ...
          >
            ...
            <MenuItem
              onClick={() => {
                handleDelete(anchorEl.client.id);
                handleMenuClose();
              }}
            >
              Delete
          ...
          >
            ...
            <DialogContent>
              ...
              <TextField
                ...
                onChange={(e) =>
                  setEditClient({ ...editClient, gender: e.target.value })
                }
              />
              <TextField
                label="Contact"
              ...
              <TextField
                ...
                onChange={(e) =>
                  setEditClient({ ...editClient, skillLevel: e.target.value })
                }
              />
              <TextField
                ...
                onChange={(e) =>
                  setEditClient({
                    ...editClient,
                    lastTrainingDate: e.target.value,
                  })
                }
              ...
              <TextField
                ...
                onChange={(e) =>
                  setEditClient({ ...editClient, subscription: e.target.value })
                }
              />
            </DialogContent>
            <DialogActions>
