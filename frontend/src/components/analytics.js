...
const getdata = async (csrfToken) => {
    return axios.get(
        "http://localhost:8000/api/get-every-class-for-today-with-attendance/",
        {
...
const getyesterdaydata = async (csrfToken) => {
    return axios.get(
        "http://localhost:8000/api/total-yesterday-attendance/",
        {
            withCredentials: true, // Required for session authentication
        }
    );
...
const getweeklydata = async (csrfToken) => {
    return axios.get(
        "http://localhost:8000/api/total-weekly-attendance/",
        {
            withCredentials: true, // Required for session authentication
        }
    );
...
const getlastweekdata = async (csrfToken) => {
    return axios.get(
        "http://localhost:8000/api/total-last-week-attendance/",
        {
            withCredentials: true, // Required for session authentication
        }
    );
...
const getmonthlydata = async (csrfToken) => {
    return axios.get(
        "http://localhost:8000/api/total-monthly-attendance/",
        {
            withCredentials: true, // Required for session authentication
        }
    );
...
const gettodaycategory = async (csrfToken) => {
    return axios.get(
        "http://localhost:8000/api/total-category-attendance-today/",
        {
            withCredentials: true, // Required for session authentication
        }
    );
...
const getweekcategory = async (csrfToken) => {
    return axios.get(
        "http://localhost:8000/api/total-category-attendance-week/",
        {
            withCredentials: true, // Required for session authentication
        }
    );
...
const getmonthcategory = async (csrfToken) => {
    return axios.get(
        "http://localhost:8000/api/total-category-attendance-month/",
        {
            withCredentials: true, // Required for session authentication
        }
    );
